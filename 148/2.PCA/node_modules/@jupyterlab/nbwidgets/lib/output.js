...
var OutputModel = (function (_super) {
    ...
    OutputModel.prototype.initialize = function (attributes, options) {
        ...
        this.widget_manager.context.session.kernelChanged.connect(function (sender, kernel) {
    ...
    OutputModel.prototype.reset_msg_id = function () {
        ...
        this._msgHook = null;
        var kernel = this.widget_manager.context.session.kernel;
...
var OutputView = (function (_super) {
    ...
    OutputView.prototype.render = function () {
        this._outputView = new outputarea_1.OutputAreaWidget({
            rendermime: this.model.widget_manager.rendermime,
            contentFactory: outputarea_1.OutputAreaWidget.defaultContentFactory,
