...
var undoablevector_1 = require("./undoablevector");
/**
...
var ModelDB = (function () {
    ...
    Object.defineProperty(ModelDB.prototype, "isPrepopulated", {
        /**
    ...
    Object.defineProperty(ModelDB.prototype, "connected", {
        /**
     ...
     */
    ModelDB.prototype.createVector = function (path) {
        var vec = new undoablevector_1.ObservableUndoableVector(new undoablevector_1.ObservableUndoableVector.IdentitySerializer());
    ...
    ModelDB.prototype._resolvePath = function (path) {
        ...
        return path_1.PathExt.normalize(path);
    };
    return ModelDB;
}());
